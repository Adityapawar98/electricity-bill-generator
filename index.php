    ...
    <div class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                <a class="navbar-brand" href="index.php"><b>Energy Ease</b></a>
            </div>
    ...
    <div class="container">
        ...
        <div class="row mt centered">
            <div class="col-lg-4">
                ...
                <h4>1 - Login</h4>
                <p>A login is a process that allows users to authenticate themselves and gain access to the website.</p>
            </div>
            <!--/col-lg-4 -->
            ...
            <div class="col-lg-4">
                ...
                <p>1.Viewing and Checking Bills – A feature in an electricity bill system where users can browse and review their bills.<br>
2.Payment Processing – Allowing users to inspect bills before making a payment.<br>
3.Bill Management System – A system where users can access past and current bills.</p>
            </div>
            <!--/col-lg-4 -->
            ...
            <div class="col-lg-4">
                ...
                <h4>3 - Transaction</h4>
                <p>1.User selects a bill to pay.<br>
2.System generates a QR code with the bill amount (if applicable).<br>
3.User completes the payment via a selected method.<br>
4.The system updates the transaction status and provides a receipt.</p>
            </div>
            <!--/col-lg-4 -->
